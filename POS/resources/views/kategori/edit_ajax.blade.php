             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                     ...
                     <div class="form-group">
                         ...
                         <input value="{{ $kategori->kategori_slug }}" type="text" name="kategori_slug" id="kategori_slug" class="form-control" required>
                         <small id="error-kategori_slug" class="error-text form-text text-danger"></small>
                     </div>
                 </div>
